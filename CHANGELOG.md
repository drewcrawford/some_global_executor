...
### Changed
- Migrated the WASM threading backend to `wasm_safe_thread` for compatibility with current dependency expectations
- Ensured worker loops exit cleanly when the last executor handle is dropped, preventing stray background workers

### Improved
- Updated project scripts used for check/test and release prep flow

## [0.1.2] - 2025-12-20

### Changed
- Updated to logwise 0.5.0 for even better logging magic
- Bumped test_executors to 0.4.1 to keep our testing infrastructure in tip-top shape
...
[Unreleased]: https://github.com/drewcrawford/some_global_executor/compare/v0.1.3...HEAD
[0.1.3]: https://github.com/drewcrawford/some_global_executor/compare/v0.1.2...v0.1.3
[0.1.2]: https://github.com/drewcrawford/some_global_executor/compare/v0.1.1...v0.1.2
